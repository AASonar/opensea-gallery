...
export default function NftArtCard({
    ...
    return(
        ...
        <div className="tracking-wide"><Subheader2>{original_owner}</Subheader2></div>
        <div className="flex flex-col items-end justify-end w-full">
            <div className="inline-flex space-x-2.5 items-center justify-end">
                <div className="flex space-x-1 items-start justify-start">
                    ...
                    <div className="tracking-wider leading-relaxed"><Header5>0.31</Header5></div>
                </div>
                    <div className="tracking-wider leading-relaxed"><Header5>$3000</Header5></div>
            </div>
        </div>
    </div>
    );
